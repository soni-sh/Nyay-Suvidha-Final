(function($) {
  ...
  /*-------------------------------------
    ...
    /*-------------------------------------
     ...
     --------------------------------------*/
    $('nav#dropdown').meanmenu({ siteLogo: "<div class='mobile-menu-back'><a href='index.html' class='logo-mobile-menu'><img src='img/Untitled design (80).png'  class='img-responsivee'/></a></div>" });
